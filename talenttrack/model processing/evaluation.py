...
# Example usage:
file_path = "/content/drive/MyDrive/res

OUTPUT..

vocab.txt: 100%
 232k/232k [00:00<00:00, 3.63MB/s]
tokenizer.json: 100%
 466k/466k [00:00<00:00, 10.8MB/s]
Extracted Resume Text:
 

& 9952653584
@ panchami3095@gmail.com

fin) https://www.linkedin.com/
in/panchami-a

© 9/91Eveerasamy
nagar,aalankumbu,Sirumugai
641 302
EDUCATION
...
PROJECTS
e@ Acomplished on project on
smart blind glass

@ Dynamic website on hotel
management

e Al imge generation

PANCHAMIL.A

An Inspiring engineer on Web
Designing embedded with ML

PROFILE

An Inspiring student on web designing technology and interested
in working on blooming technology like AR, VR, 3d Billboard
etc.. Gain Knowledge by participating workshop at NIT
University on topic problem solving creativity and at SNS
college of technology o topic Chatgpt.
...
Secured first place at project presentation "SMART
BLIND GLASS" at my college.

Secured award for scoring full grade on computer science
subject on 12th class.

« Secured best performer certification on chatgpt bootcamp.
e Received Compltion certificate on clearing python

foundation Exam at Standert platform called Nxtwave

SOCIAL RESPONSIBILITY

¢ Active volunteering on YOUTH RED CROSS Club.

¢ Done first aid for a person by gained knowledge at
YRC club.

¢ Donated basic requirements for orphanage.


Predicted Resume Category: Data Scientist
